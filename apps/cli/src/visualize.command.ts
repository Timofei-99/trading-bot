...
import { FvgDetector } from '@bot/core/detectors/fvg.detector';
import { KillzoneDetector } from '@bot/core/detectors/killzone.detector';
import { LiquidityDetector } from '@bot/core/detectors/liquidity.detector';
import { OrderBlockDetector } from '@bot/core/detectors/order-block.detector';
import { PremiumDiscountDetector } from '@bot/core/detectors/premium-discount.detector';
import { StructureDetector } from '@bot/core/detectors/structure.detector';
import { Pattern } from '@bot/core/domain/pattern';
import { renderChart } from '@bot/infra/visualization/chart.renderer';
import { renderTrade } from '@bot/infra/visualization/trade-chart.renderer';
